...
REPLACE INTO `db_server` (`name`, `value`) VALUES ('lastupdate', NULL), ('rcon_command', NULL),	('time_startup', NULL), ('time_update', NULL), ('uptime', NULL);
...
CREATE TABLE IF NOT EXISTS `db_users` (
  ...
  `flags` set('normal','premium','whitelisted','banned','admin','godmode','invis','nopvp','online','safeboxes','onevent','freezed') NOT NULL DEFAULT '',
